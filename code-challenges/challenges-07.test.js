...
const addOne = (arr) => {
  let arrNumb = arr.map( function(n,i) {
    return n +1;
  });
  return arrNumb;
}
...
const addQuestion = (arr) => {
  let arrString = arr.map(function(n,i){
    return n+'?';
  });
  return arrString;
}
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let index = 0; index < arr.length; index++) {
    arrPower.push(Math.pow(2, arr[index]))
  }
  return arrPower
};
...
const forEachTwoToThe = (arr) => {
  let arrPower=[];
  arr.forEach(element => {
    arrPower.push(Math.pow(2, element))
  });
  return arrPower;
};
...
const mapTwoToThe = (arr) => {
   let arrPower = arr.map(function(n,i){
    return Math.pow(2, n);
  })
  return arrPower;
};
